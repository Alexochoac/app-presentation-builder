function renderCompanyLayout(slideId, savedEdits) {
  ...
  return [
    '<div class="slide content ls2" style="" data-slide="' + slideId + '">',

    '  <!-- Softsolution + LiteSentry logo row \u2014 top left -->',
