...
function renderHeroLayout(slideId, savedEdits) {
  ...
  return [
    ...
    '      saveCarouselTrack();',
    '    };',
    '    document.getElementById(P + "-carousel-file").addEventListener("change", function (e) {',
    ...
    '      e.target.value = "";',
    '    });',
    '    document.getElementById(P + "-logo-file").addEventListener("change", function (e) {',
...
function renderCapabilityLayout(slideId, savedEdits) {
  ...
  var defaultTabsHtml = [
    ...
    '<div class="ls-tab-panel" data-panel="1">',
    '  <div class="ls4-proc-grid" style="grid-template-columns:1.4fr 1fr;">',
  ...
  return [
    ...
    '    /* ── Mobile base ── */',
    '    .ls4 { padding: 52px 16px 80px !important; }',
    '    /* Tab 1 — Capability Matrix */',
    '    .ls4-grid { grid-template-columns:1fr; height:auto; display:flex; flex-direction:column; }',
    '    /* Carousel moves ABOVE the table on mobile via order */',
    '    .ls4-grid .ls-carousel { order:-1; height:260px; flex:none; }',
    '    .ls4-table-wrap { overflow-x:auto; max-height:45vh; order:0; }',
    '    .ls4-table { font-size:11px; min-width:480px; }',
    ...
    '    .ls4-proc-grid { grid-template-columns:1fr; height:auto; }',
    '    .ls4-proc-table { font-size:10px; }',
    '    .ls4-proc-table-wrap { overflow-x:auto; max-height:45vh; }',
    '    .ls4-proc-table { min-width:360px; }',
    '    .ls4-proc-cards { flex-direction:column; overflow-y:visible; padding-bottom:16px; }',
    '    .ls4-proc-card { flex:none; height:180px; }',
    '    /* ── Desktop overrides ── */',
    '    @media(min-width:769px) {',
    '      .ls4 { padding: 52px 80px 0 !important; }',
    '      .ls4-grid { grid-template-columns:1.4fr 1fr; height:100%; display:grid; flex-direction:unset; }',
    '      .ls4-grid .ls-carousel { order:0; height:auto; flex:1; }',
    '      .ls4-table-wrap { overflow-x:unset; max-height:none; order:0; }',
    '      .ls4-table { font-size:inherit; min-width:unset; }',
    ...
    '      .ls4-proc-grid { grid-template-columns:1.4fr 1fr; height:100%; overflow-y:unset; }',
